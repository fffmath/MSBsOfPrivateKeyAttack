...
def factorize_p(N, partial_p, beta=0.5, epsilon=0.125, m=None, t=None, ifFlatter=True):
    """
    ...
    if n == 1:
        ...
        t = int(beta * m) if t is None else t
    ...
    for roots in small_roots(f, N, m, t, X,ifFlatter=ifFlatter):
